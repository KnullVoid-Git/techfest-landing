    ...
    <div className="border-b border-white/10 last:border-b-0">
      ...
      >
        <div className="flex items-center gap-3 sm:gap-4 pr-4">
          ...
          <span className="text-base sm:text-xl font-medium text-ink group-hover:text-accent transition-colors font-display">
            {question}
          </span>
        </div>
        <motion.div
          ...
          className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center shrink-0 text-ink-muted group-hover:border-accent/40 group-hover:text-accent transition-colors"
        >
